...
export default function Home() {
  ...
  return (
    <div className="flex flex-wrap gap-2 items-center justify-center h-full p-5 bg-[#1D1616]">
      ...
      {/* FOOTER NEXT PREV */}
      <div className={`flex justify-between items-center w-full rounded-4xl p-5 my-5 text-white ${LoadingPage ? 'animate-pulse bg-red-900' : 'bg-red-400'}`}>
        <div className="pl-4">
          {Data?.previous &&
            <button
